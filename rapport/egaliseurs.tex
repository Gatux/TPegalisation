...
\newline
Afin de caractériser un canal, on utilise $\Delta_{\tau}$ qui est l'étalement temporel du canal et $T_c$ le temps de cohérence du canal. On notera $T_s$ le temps symbole. Le canal de propagation peut être séléctif en temps et/ou en fréquence. 
\\
...
\section{Implémentation des signaux reçus}
	...
	\begin{figure}[H]
        ...
        \end{subfigure}%
\end{figure}
	On remarque qu'il y a de l'interférence entre symbole introduite par chaque canal. Le but des parties suivantes va être de se débarasser de ces distorsions, afin de décoder le message envoyé. 
...
De plus, la forte sélectivité en fréquence des canaux se manifeste par des pics de résonnance dans la réponse fréquentielle des égaliseurs.
